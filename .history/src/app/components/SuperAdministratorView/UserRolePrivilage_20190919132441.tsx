    ...
    return (
      <form className={classes.container}>
        <div className={classes.root}>
          ...
          <Grid item xs="auto">
                <div>
                  <FormControl className={classes.formControl} error={this.props.hasErrorUsers}>
                    ...
                    {this.props.hasErrorUsers && <FormHelperText>User is required!</FormHelperText>}
                ...
                <div>
                  <FormControl className={classes.formControl} fullWidth error={this.props.hasErrorRole}>
                    ...
                    <Multiselect
                      ...
                      />
                    {this.state.hasErrorRole && <FormHelperText>Role is required!</FormHelperText>}
                    </MuiThemeProvider>
                  </FormControl>
                </div>
              </Grid>
