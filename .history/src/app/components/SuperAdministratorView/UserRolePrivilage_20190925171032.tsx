...
class UserRolePrivilage extends React.Component<any, any> {
  ...
  handleFormSubmit = formSubmitEvent => {
    ...
    // var selectedRoles = this.props.selectedRoleItems;
  ...
  console.log( typeof  this.findArrayElementByName (this.props.roles,"ADMIN"));

    this.props.selectedRoleItems.map((item) =>
    //  console.log(this.findArrayElementByName (this.props.roles,{item}))
      roleItems.push(this.findArrayElementByName (this.props.roles,{item}))
    );

    // for (const [value] of this.props.selectedRoleItems.entries()) {
    //   console.log("value: ", value);
    //   roleItems.push(this.findArrayElementByName (this.props.roles,{value}));
    // }
