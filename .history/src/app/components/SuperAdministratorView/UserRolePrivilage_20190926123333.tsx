...
class UserRolePrivilage extends React.Component<any, any> {
  ...
  handleFormSubmit = formSubmitEvent => {
    ...
    //   }
      ...
      console.log("this.props.users[this.props.selectedUserIndex]");
      console.log(this.props.selectedUserIndex)
      console.log(this.props.users[this.props.selectedUserIndex]);
      console.log(this.props.users[this.props.selectedUserIndex].id);
    const sendData = {
    //   {
    //     "event":{},
...
const mapStateToProps = state => ({
  ...
  selectedUserIndex: state.userRolePrivilage.selectedUserId,
